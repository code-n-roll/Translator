...
public class ChooseSrcLangRecyclerAdapter extends RecyclerView.Adapter<ChooseSrcLangRecyclerAdapter.ViewHolder>{
    ...
    public ChooseSrcLangRecyclerAdapter(ArrayList<String> items, OnItemClickListener listener){
        mItems = items;
        mListener = listener;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.content_choose_src_lang_item, parent, false);
