...
import com.karanchuk.roman.testtranslate.common.Constants.UNIQUE_HISTORY_FRAGMENT_ID
...
//        View translatorNavView = navigation.findViewById(R.id.navigation_translate);
        ...
        mHistoryRecycler!!.adapter = StoredRecyclerAdapter(
...
//        view.performClick()
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        return if (item.groupId == Constants.UNIQUE_HISTORY_FRAGMENT_ID) {
            when (item.itemId) {
